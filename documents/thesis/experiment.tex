...
\caption[F1-Wert jedes Epochs des Validierungsdatensatzes mit Early Fusion ohne Anwendung von Oversampling]{F1-Wert jedes Epochs des Validierungsdatensatzes mit Early Fusion der 9 Bider jede*r Patient*in ohne Anwendung von Oversampling}\label{cap:f1_ef_non_oversampling}
...
\caption[F1-Wert jedes Epochs des Validierungsdatensatzes mit Late Fusion ohne Anwendung von Oversampling]{F1-Wert jedes Epochs des Validierungsdatensatzes mit Late Fusion der 9 Bider jede*r Patient*in ohne Anwendung von Oversampling}\label{cap:f1_lf_non_oversampling}
