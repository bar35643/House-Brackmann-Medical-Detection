...
\begin{tabular}{c|c}
Modul      & \begin{tabular}[c]{@{}c@{}}neue Pixelgröße\\ der Bilder\end{tabular} \\ \hline\hline
Symmetrie  & 640x640                                                              \\ %\hline
Lidschluss & 420x500                                                              \\ %\hline
Mund       & 640x420                                                              \\ %\hline
Strin      & 640x300                                                              \\ %\hline
Direkt     & 640x640                                                              \\ \hline
\end{tabular}
...
\vspace{1ex}\end{table}\label{table:new_size}
...
\caption[Lernrate in ahbängigkeit des jeweiligen Epochs]{Lernrate in Ahbängigkeit des jeweiligen Epochs. Dabei werden eine Exponentialfunktion mit einer Cosinusfunktion miteinander verschmolzen.}\label{cap:lrrate}
...
\begin{table}[h]\vspace{1ex}\centering
  ...
  \caption[training]{training}\label{cap:tmp}
\vspace{2ex}\end{table}\label{table:tmp}
...
\begin{table}[h]\vspace{1ex}\centering
  ...
  \caption[validierung]{validierung}\label{cap:tmp}
\vspace{2ex}\end{table}\label{table:tmp}


\begin{figure}[!h]\centering
\makebox[0pt]{\includesvg[inkscapelatex=false, width=0.9\textwidth]{./images/f1_sequential}}
\caption[tmp]{TODO sequenziell kein oversampling validierung}\label{cap:f1_sequential_non_osersampling}
\end{figure}\label{fig:f1_sequential_non_osersampling}

\begin{figure}[!h]\centering
\makebox[0pt]{\includesvg[inkscapelatex=false, width=0.9\textwidth]{./images/f1_sequential_oversampling}}
\caption[tmp]{TODO sequenziell oversampling validierung}\label{cap:f1_sequential_oversampling}
...
\begin{figure}[!h]\centering
\makebox[0pt]{\includesvg[inkscapelatex=false, width=0.9\textwidth]{./images/f1_early_fusion}}
\caption[tmp]{TODO Early Fusion kein oversampling validierung}\label{cap:f1_ef_non_osersampling}
\end{figure}\label{fig:f1_ef_non_osersampling}

\begin{figure}[!h]\centering
\makebox[0pt]{\includesvg[inkscapelatex=false, width=0.9\textwidth]{./images/f1_early_fusion_oversampling}}
\caption[tmp]{TODO Early Fusion oversampling validierung}\label{cap:f1_ef_oversampling}
