...
\begin{table}[!htb]\vspace{1ex}\centering
  ...
  \multicolumn{1}{c|}{\multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}vor Anpassung\\ der Bildgröße\end{tabular}}}  & \# & \multicolumn{1}{c|}{a} & \multicolumn{1}{c|}{b} & c \\ \cline{2-5}
  \multicolumn{1}{c|}{} & in \% & \multicolumn{1}{c|}{a}       & \multicolumn{1}{c|}{b}                 & c      \\ \hline
  \multicolumn{1}{c|}{\multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}nach Anpassung\\ der Bildgröße\end{tabular}}} & \# & \multicolumn{1}{c|}{a} & \multicolumn{1}{c|}{b} & c \\ \cline{2-5}
  \multicolumn{1}{c|}{} & in \% & \multicolumn{1}{c|}{a}       & \multicolumn{1}{c|}{b}                 & c      \\ \hline
  \end{tabular}
...
%\section{Sequenziell}\label{oversampling}
%\textbf{TODO}
...
\subsection{? Mittel der Zeilensumme}\label{rowsum}
\textbf{TODO}
