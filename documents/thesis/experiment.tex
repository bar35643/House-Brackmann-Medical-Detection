...
\begin{figure}[!b]\centering
    \begin{minipage}{0.5\textwidth}\centering
        ...
        \def\myScale{0.85} % 1.5 is a good scale. Values under 1 may need smaller fonts!
    ...
    \begin{minipage}{0.5\textwidth}\centering
      ...
      \node []               at (xaxis) {Berechnete Klasse ($p$)};
      \end{tikzpicture}
        \caption*{\textbf{(b)} mit Oversampling}\label{cap:b_oversampling}
    \end{minipage}
...
\begin{table}[!h]\vspace{1ex}\centering
  ...
  \caption[Statistisch besten Werte der Metirken des Trainingsdatensatzes mit und ohne Oversampling bei sequenzieller Anordnung]{Statistisch besten Werte der Metirken des Trainingsdatensatzes mit und ohne Oversampling bei sequenzieller Anordnung. Der beste F1-Wert wurde dabei von der direkten Ermittlung des Grades unter Benutzung von Oversampling getroffen. Klar erkennbar ist der positive Effekt von Oversampling während des Trainings.}\label{cap:sequential_train}
\vspace{1ex}\end{table}\label{table:sequential_train}
...
\begin{table}[!h]\vspace{1ex}\centering
  ...
  \caption[Statistisch besten Werte der Metirken des Validierungsdatensatzes mit und ohne Oversampling bei sequenzieller Anordnung]{Statistisch besten Werte der Metirken des Validierungsdatensatzes mit und ohne Oversampling bei sequenzieller Anordnung. Der beste F1-Wert wurde dabei von der direkten Ermittlung des Grades unter Benutzung von Oversampling getroffen.}\label{cap:sequential_val}
\vspace{1ex}\end{table}\label{table:sequential_val}

\clearpage
\begin{figure}[t]\centering
\makebox[0pt]{\includesvg[inkscapelatex=false, width=0.83\textwidth]{./images/f1_sequential}}
\caption[F1-Wert jedes Epochs des Validierungsdatensatzes mit der sequenziellen Verarbeitung ohne Anwendung von Oversampling]{F1-Wert jedes Epochs des Validierungsdatensatzes mit der sequenziellen Verarbeitung der neun Bilder jede*r Patient*in ohne Anwendung von Oversampling.}\label{cap:f1_sequential_non_oversampling}
\end{figure}\label{fig:f1_sequential_non_oversampling}

\begin{figure}[b]\centering
\makebox[0pt]{\includesvg[inkscapelatex=false, width=0.83\textwidth]{./images/f1_sequential_oversampling}}
...
\begin{table}[!h]\vspace{1ex}\centering
  ...
  \caption[Statistisch besten Werte der Metirken des Trainingsdatensatzes mit und ohne Oversampling mit Anwendung von Early Fusion]{Statistisch besten Werte der Metirken des Trainingsdatensatzes mit und ohne Oversampling  mit Anwendung von Early Fusion. Die besten erzielten Werte wurden mit der direkten Ermittlung erreicht.}\label{cap:ef_train}
\vspace{1ex}\end{table}\label{table:ef_train}
...
\begin{table}[!h]\vspace{1ex}\centering
  ...
  \caption[Statistisch besten Werte der Metirken des Validierungsdatensatzes mit und ohne Oversampling mit Anwendung von Early Fusion]{Statistisch besten Werte der Metirken des Validierungsdatensatzes mit und ohne Oversampling  mit Anwendung von Early Fusion. Die besten erzielten Werte wurden mit der direkten Ermittlung erreicht.}\label{cap:ef_val}
\vspace{1ex}\end{table}\label{table:ef_val}

\begin{figure}[t]\centering
\makebox[0pt]{\includesvg[inkscapelatex=false, width=0.85\textwidth]{./images/f1_early_fusion}}
\caption[F1-Wert jedes Epochs des Validierungsdatensatzes mit Early Fusion ohne Anwendung von Oversampling]{F1-Wert jedes Epochs des Validierungsdatensatzes mit Early Fusion der neun Bilder jede*r Patient*in ohne Anwendung von Oversampling.}\label{cap:f1_ef_non_oversampling}
...
\begin{table}[!h]\vspace{1ex}\centering
  ...
  \caption[Statistisch besten Werte der Metirken des Trainingsdatensatzes mit und ohne Oversampling mit Anwendung von Late Fusion]{Statistisch besten Werte der Metirken des Trainingsdatensatzes mit und ohne Oversampling  mit Anwendung von Late Fusion. Die besten erzielten Werte wurden mit der direkten Ermittlung erreicht.}\label{cap:lf_train}
\vspace{1ex}\end{table}\label{table:lf_train}
...
\begin{table}[!h]\vspace{1ex}\centering
  ...
  \caption[Statistisch besten Werte der Metirken des Validierungsdatensatzes mit und ohne Oversampling mit Anwendung von Late Fusion]{Statistisch besten Werte der Metirken des Validierungsdatensatzes mit und ohne Oversampling  mit Anwendung von Late Fusion. Die besten erzielten Werte wurden mit der direkten Ermittlung erreicht.}\label{cap:lf_val}
\vspace{1ex}\end{table}\label{table:lf_val}

\begin{figure}[t]\centering
\makebox[0pt]{\includesvg[inkscapelatex=false, width=0.85\textwidth]{./images/f1_late_fusion}}
\caption[F1-Wert jedes Epochs des Validierungsdatensatzes mit Late Fusion ohne Anwendung von Oversampling]{F1-Wert jedes Epochs des Validierungsdatensatzes mit Late Fusion der neun Bilder jede*r Patient*in ohne Anwendung von Oversampling.}\label{cap:f1_lf_non_oversampling}
...
\begin{tikzpicture}
  ...
  \end{axis}
\end{tikzpicture}
\caption[Laufzeiten des Systems mit und ohne Datenbank als Cache]{Laufzeiten des Systems (fünf Epochs, 53 Datensätze) mit und ohne Datenbank als Cache und variabler \ac{lru} Größe.}\label{cap:analyze}
\end{center}
