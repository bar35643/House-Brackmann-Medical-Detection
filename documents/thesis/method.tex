...
\begin{figure}[!b]\centering
    ...
    \end{minipage}
    \caption{Veranschaulichung der Ungleichen Klassenverteilung jedes Modules (a-d) anhand des gegebenen Datensatzes. Bei einer Gleichverteilung müssen alle Teile gleich groß sein.}\label{cap:vert_pie}
